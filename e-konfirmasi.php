	...
	<table width="74%" border="0" cellpadding="0" cellspacing="0" bordercolor="#99CC99" align="center">
	  ...
	  <tr>
	    ...
	    <ol>
	      ...
	      <li><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Kemudian kirim ke alamat <strong>sumarna_agus@yahoo.com</strong>. dengan <em>Subject:</em><strong>Pesanan <? echo $_GET['kode'];?></strong></font></li>
